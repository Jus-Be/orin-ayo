# Introduction
Orin Ayo is live music production web application implemented in JavaScript and run inside a browser as a web page or browser extension external window.
...
# In use
## Controlling an external device with RealLPC
