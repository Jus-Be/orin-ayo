...
const assets = [
  ...
  "./js/0270_EGuitar_FSBS_SF2_file.js",
  "./js/0250_RG_Acoustic_SF2_file.js",
  "./js/0250_Aspirin_sf2_file.js",
  "./js/0250_Chaos_sf2_file.js",
  "./js/0250_LK_AcousticSteel_SF2_file.js",
  "./js/0253_Acoustic_Guitar_sf2_file.js",
  "./js/0341_Aspirin_sf2_file.js",  
  "./js/0260_JCLive_sf2_file.js",
  "./dist/converse.js",  
  "./assets/pedalboard.js",   
  "./js/pureknob.js",  
  "./js/basic-pitch.js",    
  "./js/tonal.min.js",    
  "./js/stream-deck.js",  
  "./js/chordsheet.js",  
  "./js/webaudio-font-player.js",  
  "./js/web-components.min.js",
  "./js/note.js",
  "./js/hitBar.js",
  "./js/gameBoard.js",
  "./js/webmidi.min.js",
...
self.addEventListener("install", installEvent => {
  installEvent.waitUntil(
    caches.open(staticOrinAyo).then(cache => {
      if (location.protocol != "chrome-extension:") cache.addAll(assets);
    })
  );
});
