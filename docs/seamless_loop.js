...
function SeamlessLoop() {
	...
	this._eventEnded = function(aud, id) {
...
SeamlessLoop.prototype.addUri = function(uri, length, id, output) {
	...
	this.audios[id]._1.addEventListener("playing", function() {t._eventPlaying(t.audios[id]._2, id);});
	this.audios[id]._2.addEventListener("playing", function() {t._eventPlaying(t.audios[id]._1, id);});
	this.audios[id]._1.addEventListener("ended", function() {t._eventEnded(t.audios[id]._1, id);});
	this.audios[id]._2.addEventListener("ended", function() {t._eventEnded(t.audios[id]._2, id);});
